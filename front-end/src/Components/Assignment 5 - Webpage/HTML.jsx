...
import assignmentPicture1 from "./Assignment 5 - HTML.png";
import assignmentPicture2 from "./Assignment 5 - CSS.png";
      ...
      <React.Fragment>
            ...
            <div>
              <div id="assignment5-content-body">
                ...
                <p>
                  ...
                  correctly use html and css together. You'll notice that
                  there's an error in the developer tools whereas it says
                  something similar to " html cannot appear as a child of div."
                  That's simply because this page is part of the main React
                  layout, which is configured using Routing. so the Route for
                  this page is inside of a div element. <br />
                  Also using borders around everything so it's easier to see
                  that all the requirements were met.
                </p>
                <article id="assignment5-first-article">
                  ...
                  <p>
                    ...
                    I'm writing this line right here to fill out the webpage
                    with more text because I'm too lazy to find sample text to
                    copy paste here instead.
                  </p>
                </article>
                ...
                <article id="assignment5-second-article">
                  ...
                  <p>
                    This is the second "paragraph" of the second article
                    element. I'm writing this line right here to fill out the
                    webpage with more text because I'm too lazy to find sample
                    text to copy paste here instead.
                  </p>
                  <img
                    id="assignment5-picture"
                    alt="smart.jpg"
                    ref="smart.jpg"
                    src={smart}
                  />
        ...
        <div>
          ...
          <img
            ...
            alt="HTML Assignment.jpg"
            ref="smart.jpg"
            src={assignmentPicture1}
          />
          <img
            className="col-5 mb-5"
            alt="CSS Assignment.jpg"
            src={assignmentPicture2}
          />
        </div>
      </React.Fragment>
    );
